...
import { CalendarIcon, TrendingUp, TrendingDown, Minus, AlertTriangle, ChevronDown } from "lucide-react";
...
const HistoricalData = () => {
  ...
  const getRiskBadge = (count: number) => {
    ...
    if (count >= 10) return <Badge variant="warning" className="ml-2">Medium Risk</Badge>;
